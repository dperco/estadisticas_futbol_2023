...
#Este Trigger se dispara antes de insertar un nuevo equipo en la tabla 'datos_equipos'.
...
#Este Trigger se dispara después de actualizar un equipo en la tabla 'datos_equipos'. 
...
#Este Trigger se dispara antes de insertar un nuevo jugador en la tabla 'datos_de_jugadores'. 
#Registra quién está realizando la inserción, la fecha y la hora en que se realiza la acción, la acción en sí (INSERCIÓN)
