...
#CREATE INDEX idx_posicion_jugador ON posicion_jugador (posicion_campo);

######################################
#ALTER TABLE datos_de_jugadores
#ADD CONSTRAINT fk_nacionalidad_jugador FOREIGN KEY (nationality) REFERENCES paises(country_name),
#ADD CONSTRAINT fk_equipo_actual_jugador FOREIGN KEY (current_club) REFERENCES datos_equipos(team_name),
#ADD CONSTRAINT fk_posicion_jugador_jugador FOREIGN KEY (position_campo) REFERENCES posicion_jugador(posicion_campo);
#########################################

#ALTER TABLE datos_equipos
#ADD CONSTRAINT fk_pais_equ FOREIGN KEY (country) REFERENCES paises(country_name);
...
##################################################################################
#CREATE UNIQUE INDEX idx_common_name ON estadisticas_de_equipos (common_name);


#ALTER TABLE Tabla_campeonato
#ADD CONSTRAINT fk_pais_campeonato FOREIGN KEY (country) REFERENCES paises(country_name),
#ADD CONSTRAINT fk_equipo_campeonato FOREIGN KEY (common_name) REFERENCES datos_equipos(common_name),
#ADD CONSTRAINT fk_equipo_estadisticas FOREIGN KEY (common_name) REFERENCES estadisticas_de_equipos(common_name);
######################################################################################################################
